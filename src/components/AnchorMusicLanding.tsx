...
export default function AnchorMusicLanding({
  onAuthSuccess,
}: AnchorMusicLandingProps): JSX.Element {
  ...
  const handleOTPSubmit = (e: React.FormEvent) => {
    ...
    window.alert(
      `OTP ${otpCode} verified successfully! Welcome to Anchormusic!`
    );
    if (onAuthSuccess) {
      onAuthSuccess();
    }
  ...
  return (
    <div className="min-h-screen bg-white text-blue-500 flex flex-col overflow-x-hidden">
      ...
      {/* Landing navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white backdrop-blur-lg border-b border-white/10 transition-all duration-300">
      ...
      <main className="flex-1 pt-24 relative z-10">
        ...
        <section
          id="home"
          className={`max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 text-center transition-all duration-1000 ${
        ...
        >
          ...
          <p className="text-sm sm:text-base lg:text-lg text-gray-500 max-w-2xl mx-auto mb-6 sm:mb-8 leading-relaxed px-4">
            Join the ultimate platform connecting talented musicians with
            students and incredible opportunities. Whether you're seeking gigs,
            teaching opportunities, or collaborations — we've got you covered.
          </p>
        ...
        <section
          id="hero"
          className="py-12 sm:py-16 bg-gradient-to-br from-white/5 via-white/3 to-transparent"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
            <div className="order-2 lg:order-1 space-y-4 sm:space-y-6">
              ...
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                Browse through thousands of verified musician profiles, complete
                with audition clips, reviews, and real-time booking
                availability. Finding your ideal collaborator has never been
                easier.
              </p>
              ...
              <ul className="space-y-3 text-sm sm:text-base text-gray-300">
                {[
                  {
                    icon: Star,
                    text: "Verified profiles with authentic reviews",
                  },
                  {
                    icon: Calendar,
                    text: "Integrated scheduling & secure payments",
                  },
                  {
                    icon: Users,
                    text: "Perfect for teachers, session players & bands",
                  },
                ].map((item, idx) => (
              ...
              {[
                {
                  ...
                  description:
                    "Browse our curated network of musicians filtered by instrument, genre, experience level, and competitive rates.",
                },
                {
                  icon: Briefcase,
                  title: "Secure Bookings",
                  description:
                    "Post opportunities and hire with confidence through our verified platform with built-in contracts and protection.",
                },
                {
                  icon: BookOpen,
                  title: "Teach & Earn",
                  description:
                    "Offer private lessons, manage your student roster, and handle scheduling seamlessly through our platform.",
                },
              ].map((feature, idx) => (
                <div
                  key={idx}
        ...
        <section
          id="about"
          className="py-12 sm:py-20 bg-white/3 backdrop-blur-sm"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-sm sm:text-base text-gray-500 leading-relaxed">
                  We're more than just a platform — we're a community dedicated
                  to empowering musicians worldwide. Our mission is to simplify
                  connections, streamline bookings, and ensure every transaction
                  is secure and transparent.
                </p>
                <p className="text-sm sm:text-base text-gray-500 leading-relaxed">
                  From emerging artists to seasoned professionals, Anchormusic
                  provides the tools and network you need to focus on what
                  matters most — creating incredible music.
                </p>
                <div className="flex flex-wrap gap-3 sm:gap-4 pt-4">
                  {["Trusted", "Secure", "Professional", "Global"].map(
                    (badge, idx) => (
                      <div
                        key={idx}
              ...
              {[
                {
                  ...
                  description:
                    "Rigorous verification process ensuring authentic credentials, reviews, and qualifications to build trust within our community.",
                },
                {
                  icon: Lock,
                  title: "Secure Transactions",
                  description:
                    "Industry-leading payment protection with escrow services, deposit management, and secure fund transfers for complete peace of mind.",
                },
                {
                  icon: Calendar,
                  title: "Smart Scheduling",
                  description:
                    "Intuitive calendar integration with automated reminders, booking confirmations, and seamless availability management.",
                },
              ].map((service, idx) => (
                <div
                  key={idx}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="text-xs sm:text-sm text-gray-400 text-center md:text-left">
                © 2025 Anchormusic. All rights reserved. Empowering musicians
                worldwide.
              </div>
            </div>
          </div>
      ...
      {showAuth && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white backdrop-blur-xl rounded-2xl p-6 sm:p-8 max-w-md w-full border border-white/20 max-h-[90vh] overflow-y-auto transform transition-all duration-300 animate-slideUp shadow-2xl shadow-purple-500/30">
